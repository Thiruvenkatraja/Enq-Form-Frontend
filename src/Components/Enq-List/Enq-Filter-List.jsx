...
const EnqFilterList = () => {
    ...
    const filter = ["Confrimed","Demo Completed","Demo Scheduled","Yet to Schedule Demo","Trainer Needed"]
            ...
            if (search === "") {
              ...
              let temp = allVal.filter(
                (data) =>
                  ...
                  data.followupcalldate.toString().toLowerCase().trim().includes(search) ||
          ...
          <Multiselect
            ...
            onSelect={(event) => {
              if (event.length === 0) {
                ...
                let temp = allVal.filter((data) => event.includes(data.followupcalldate));
                setPaged(temp) || setList(temp);
                console.log(event);
              }
            }}
          ...
          <Multiselect
            ...
            onSelect={(event) => {
              if (event.length === 0) {
                ...
                let temp = allVal.filter((data) => event.includes(data.location));
                setPaged(temp) || setList(temp);
                console.log(event);
              }
            }}
          ...
          <Multiselect
            ...
            onSelect={(event) => {
              if (event.length === 0) {
                ...
                let temp = allVal.filter((data) => event.includes(data.course));
                setPaged(temp) || setList(temp);
                console.log(event);
              }
            }}
          ...
          <Multiselect
            ...
            onSelect={(event) => {
              if (event.length === 0) {
                ...
                let temp = allVal.filter((data) => event.includes(data.feestructure));
                setPaged(temp) || setList(temp);
                console.log(event);
              }
            }}
          ...
          <Multiselect
            ...
            onSelect={(event) => {
              if (event.length === 0) {
                ...
                let temp = allVal.filter((data) => event.includes(data.experienceby));
                setPaged(temp) || setList(temp);
                console.log(event);
              }
            }}
          ...
          <Multiselect
            ...
            onSelect={(event) => {
              if (event.length === 0) {
                ...
                let temp = allVal.filter((data) => event.includes(data.infosource));
                setPaged(temp) || setList(temp);
                console.log(event);
              }
            }}
          ...
          <Multiselect
            ...
            onSelect={(event) => {
              if (event.length === 0) {
                ...
                let temp = allVal.filter((data) => event.includes(data.purpose));
                setPaged(temp) || setList(temp);
                console.log(event);
              }
            }}
          ...
          <Multiselect
            ...
            onSelect={(event) => {
              if (event.length === 0) {
                ...
                let temp = allVal.filter((data) => event.includes(data.mode));
                setPaged(temp) || setList(temp);
                console.log(event);
              }
            }}
          ...
          <button className="btn btn-primary okay" onClick={toggle12}>
            ...
            <tbody>
              {paged.filter((fil) => {
                   ...
                   if(filter.includes(fil.followupstatus)){
                    return fil
                   }
              })
              .map((obj) => (
